             ...
             <input type="hidden" name="news_type" value="<?php echo $_REQUEST['news_type'];?>">
                <table class="mt15">
                    ...
                    <tr>
                        ...
                        <td colspan="3"><?php echo $model->news_code;?></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td style="display: none;"><?php echo $form->labelEx($model, 'order_num'); ?></td>
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                          <?php echo $form->textArea($model,'news_introduction', array('class' => 'input-text', 'maxlength'=>'100' )); ?>
                          <p>*简短介绍，最多可输入100个字符，含数字特殊符号：-&nbsp;/&nbsp;\&nbsp;等。</p>
                    ...
                    <tr>
                        <td style="display: none;"><?php echo $form->labelEx($model,'recommend_type'); ?></td>
                        <td colspan="3" style="display: none;">
                        ...
                        <td colspan="3">
                            ...
                            <div class="upload_img fl" id="upload_pic_club_news_pic">
                                ...
                                <img src="<?php echo $basepath->F_WWWPATH.$v['news_pic'];?>" width="100">
                                    ...
                                    <td><textarea oninput="LimitText(this)" onpropertychange="LimitText(this)" name="club_news_pic[<?php echo $v['id'];?>][intro]" class="input-text" maxlength="30" style="width:80%;height:80px;" placeholder="图片说明（30个字）"><?php echo $v['introduce'];?></textarea></td>
                    ...
                    <tr class="table-title">
                    <td colspan="4"><strong>操作信息</strong></td>
                </tr>
                <tr>
                    <td>可执行操作</td>
